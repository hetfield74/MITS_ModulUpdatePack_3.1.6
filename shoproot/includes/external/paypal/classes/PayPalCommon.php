<?php
/* -----------------------------------------------------------------------------------------
   $Id: PayPalCommon.php 16635 2025-11-24 11:50:08Z GTB $
...
class PayPalCommon extends PayPalAuth {
  ...
  function calculate_total($mode = 1) {
    ...
    // BOF - Fallback for shop version <= 1.06 rev 4642 SP1
    $this->free_shipping_value_over = ((isset($free_shipping_value_over) ? $free_shipping_value_over : MODULE_ORDER_TOTAL_SHIPPING_FREE_SHIPPING_OVER));
    // EOF - Fallback for shop version <= 1.06 rev 4642 SP1
