...
/* -----------------------------------------------------------------------------------------
  ...
  {      
    ...
    if (function_exists('mainMenue')) $menu_access[] = '<li><a href="javascript:void(0)" class="menuBoxContentLinkSub"> -PayPal</a><ul>';
    ...
    // BOF - Fallback for shop version 1.0x
    if (function_exists('mainMenue')) $menu_access[] = '</ul></li>';
    // EOF - Fallback for shop version 1.0x
