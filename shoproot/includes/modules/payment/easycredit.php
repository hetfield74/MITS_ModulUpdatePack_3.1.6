<?php
/* -----------------------------------------------------------------------------------------
   $Id: easycredit.php 16583 2025-10-15 09:45:06Z GTB $
  ...
  // BOF - fallback for shop version <= 2.0.7.2
  ...
  // EOF - fallback for shop version <= 2.0.7.2
  ...
  class easycredit extends TeambankPayment {
    ...
    function __construct() {
      ...
      if ($this->enabled === true) {
        ...
        // BOF - fallback for shop version <= 2.0.7.2
        if (isset($main) && is_object($main) && method_exists($main, 'getPopupParams')) {
