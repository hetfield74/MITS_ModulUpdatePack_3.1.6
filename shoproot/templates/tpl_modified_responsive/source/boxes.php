...
//	full content
// -----------------------------------------------------------------------------------------
  if (!in_array(basename($PHP_SELF), $fullcontent) || defined('DISPLAY_ERROR_HANDLER') || (isset($display_mode) && $display_mode == 'error')) {
...
if (defined('DISPLAY_ERROR_HANDLER') || (isset($display_mode) && $display_mode == 'error') || (in_array(basename($PHP_SELF), $bestsellers) && !isset($_GET['cPath']) && !isset($_GET['manufacturers_id']))) {
