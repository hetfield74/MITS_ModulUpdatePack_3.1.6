<?php
/* -----------------------------------------------------------------------------------------
   $Id: paypalacdc.php 16669 2025-12-04 11:01:41Z GTB $
...
$lang_array = array(
  ...
  'MODULE_PAYMENT_PAYPALACDC_TEXT_DESCRIPTION' => 'Im letzten Step im Checkout werden Sie gebeten die Kreditkartendaten einzugeben, um hier die Bestellung zu bezahlen.<br /><br /><strong><font color="red">ACHTUNG:</font></strong> Damit der Bestellstatus korrekt gesetzt wird, m&uuml;ssen folgende <a href="'.xtc_href_link('paypal_webhook.php').'">Webhooks</a> in der PayPal Konfiguration eingestellt werden, damit der Status korrekt umgestellt wird:<ul><li>PAYMENT.CAPTURE.COMPLETED</li><li>PAYMENT.CAPTURE.DECLINED</li><li>PAYMENT.CAPTURE.DENIED</li><li>PAYMENT.CAPTURE.PENDING</li></ul>F&uuml;r Vault oder wiederkehrende Zahlungen m&uuml;ssen noch folgende Webhooks gesetzt werden:<ul><li>VAULT.CREDIT-CARD.CREATED</li><li>VAULT.CREDIT-CARD.DELETED</li><li>VAULT.CREDIT-CARD.UPDATED</li></ul>',
  ...
  'MODULE_PAYMENT_PAYPALACDC_LP' => '<br /><br />F&uuml;r diese Zahlungsart ben&ouml;tigen Sie ein PayPal H&auml;ndler Konto.<br /><a target="_blank" href="https://www.paypal.com/business"><strong>Jetzt PayPal Konto hier erstellen.</strong></a>',
  ...
  'MODULE_PAYMENT_PAYPALACDC_TEXT_SAVE_PAYMENT' => 'Zahlungsmethode sicher speichern. So k&ouml;nnen Sie beim n&auml;chsten Einkauf schneller, einfacher und bequemer bezahlen.',
  'MODULE_PAYMENT_PAYPALACDC_TEXT_OR' => 'oder',
);
