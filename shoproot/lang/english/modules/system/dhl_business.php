...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_DHL_BUSINESS_ACCOUNT_DESC', 'Account ID, Format ISO2:ID separated by comma (standard WORLD:01).<br>If "Warenpost" or "Returning" has a different ID, add PK (parcel), KP (small parcel), WP (Warenpost) or RT (Returning).<br>Example: WORLD:01PK,WORLD:02KP,WORLD:03WP,WORLD:04RT');
